...
extern "C" void argstart(int *argc, char **argv, struct Argstate *args);
...
extern "C" int argnext(struct Argstate *);
...
extern "C" char *argnextvalue(struct Argstate *);
...
extern "C" char *argvalue(struct Argstate *);
